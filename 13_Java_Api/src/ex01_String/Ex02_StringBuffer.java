...
public class Ex02_StringBuffer {
  ...
  public static void main(String[] args) {
    ...
    // StringBuffer 객체에 저장된 문자열을 String으로 변환 - StringBuffer를 사용하면 String으로 변환
    String str = sb.toString();
    System.out.println(str);
    // ha + va = hava -> hava + na = havana   StringBuffer에서 hava는 없음. 중간 객체(hava)가 생기지 않기 때문에 메모리 낭비가 줄어들 수 있다.
