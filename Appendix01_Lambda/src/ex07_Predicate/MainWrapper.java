...
public class MainWrapper {
  ...
  /*
   * Predicate 인터페이스
   * 1. 하나의 파라미터를 전달 받아서 true 또는 false를 반환하는 함수형 인터페이스이다.
   * 2. 특정 값을 전달하면 해당 값을 검사한 뒤 true/false 여부를 반환하는 text() 메소드를 가지고 있다.
   * 3. 어떤 값이 조건을 만족하는지 설명하기 때문에 "설명부(Predicate)"라고 부른다.  
   * 4. 형식
   * 
   *    @FunctionalInterface
