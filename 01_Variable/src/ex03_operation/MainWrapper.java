...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    double result = (double)i / j;    // 5.0 / 2  --(자동변환)-->  5.0 / 2.0
  ...
  public static void ex04() {
    ...
    boolean result6 = a != b; // a와 b가 다르면 treu, 아니면 false
    ...
    boolean notResult = !(x == 10);               // x != 10와 동일한 조건, false
    ...
    // 1. 논리 ADN : 결과가 false인 조건이 나타나면 더 이상 조건을 체크하지 않는다. 최종 결과가 false로 정해졌기 때문이다.
  ...
  public static void ex06() {
    ...
    String str6 = String.valueOf(100);    // 잘 안 쓸 뿐이다.
