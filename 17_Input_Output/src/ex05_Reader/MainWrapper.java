...
public class MainWrapper {
  ...
  public static void ex03() {
    ...
    // String으로 읽기 (BufferedReader가 속도도 빠르고 쉽다 !)
  ...
  public static void ex04() {
    ...
    try {
      ...
      // 바이트스트림으로 읽고(fileinputstream) 문자스트림으로 바꿔주고(inputstreamreader) 버퍼를 끼워 성능 향상(bufferedreader)도 했다.
